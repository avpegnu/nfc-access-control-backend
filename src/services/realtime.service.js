...
class RealtimeService {
  ...
  initialize() {
    ...
    const unsubDoorStatus = firebaseService.subscribe('doors/door_main/status', (status) => {
    ...
    const unsubAccessLogs = firebaseService.subscribeChild('accessLogs', 'child_added', (log) => {
