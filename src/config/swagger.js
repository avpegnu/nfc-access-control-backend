    ...
    components: {
      securitySchemes: {
        ...
        DeviceToken: {
          ...
          in: 'header',
          name: 'X-Device-Token',
          description: 'Device token for ESP32 authentication',
        },
        ApiKey: {
          type: 'apiKey',
          in: 'header',
        ...
        Card: {
          ...
          properties: {
            ...
            policy: {
              type: 'object',
              properties: {
                access_level: { type: 'string', enum: ['guest', 'staff', 'manager', 'admin'] },
        ...
        CardAssignRequest: {
          ...
          properties: {
            ...
            policy: {
              type: 'object',
              properties: {
                access_level: { type: 'string', enum: ['guest', 'staff', 'manager', 'admin'], default: 'staff' },
                valid_until: { type: 'string', format: 'date-time' },
              },
            },
          },
